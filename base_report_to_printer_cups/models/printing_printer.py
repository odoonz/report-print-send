...
class PrintingPrinter(models.Model):
    ...
    def cancel_all_jobs(self, purge_jobs=False):
        ...
        return super(PrintingPrinter, self - cups_printers).cancel_all_jobs(
    ...
    def enable(self):
        ...
        return super(PrintingPrinter, self - cups_printers).enable()
    ...
    def disable(self):
        ...
        cups_printers.mapped("server_id").update_printers()
        return super(PrintingPrinter, self - cups_printers).disable()
    ...
    def print_test_page(self):
        ...
        cups_printers.mapped("server_id").update_jobs(which="completed")
        return super(PrintingPrinter, self - cups_printers).print_test_page()
